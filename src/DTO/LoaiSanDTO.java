...
public class LoaiSanDTO {
    ...
    public LoaiSanDTO(String Ten_Loai, String Mo_Ta, Date Ngay_Tao, Date Ngay_Cap_Nhat, int status) {
    ...
    public LoaiSanDTO(int ID, String Ten_Loai, String Mo_Ta, int status) {
        this.ID = ID;
        this.Ten_Loai = Ten_Loai;
        this.Mo_Ta = Mo_Ta;
        this.Status = status;
